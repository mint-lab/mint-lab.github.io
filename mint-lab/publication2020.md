...
* Jae-Yeong Lee, Sunglok Choi, and Jaeho Lim, **Detection of High-Risk Intoxicated Passengers in Video Surveillance**, in Proceedings of IEEE International Conference on Advanced Video and Signal-based Surveillance (AVSS), 2018 [DOI](http://doi.org/10.1109/AVSS.2018.8639485)
* Jae-Yeong Lee, Sunglok Choi, Jaeho Lim, Saeyeong Ahn, Hodam Lee, and Sangjae Lee, **Intelligent Visual Surveillance System for Safety Management in Railway Stations**, in Proceedings of Asian Conference on Railway Engineering and Transportation (ART), 2018
...
* Sunglok Choi, Jaehyun Park, Jaemin Byun, and Wonpil Yu, **Robust Ground Plane Detection from 3D Point Clouds**, in Proceedings of International Conference on Control, Automation and Systems (ICCAS), 2014 [DOI](http://doi.org/10.1109/ICCAS.2014.6987936) <span style="color:red">"Best Presentation Award"</span>
...
* Jaehyun Park, Sunglok Choi, and Wonpil Yu, **Quadtree Sampling-based Superpixels for 3D Range Data**, in Proceedings of IEEE International Conference on Robotics and Automation (ICRA), 2014 [DOI](http://doi.org/10.1109/ICRA.2014.6907667)
* Sunglok Choi, Jaehyun Park, and Wonpil Yu, **Resolving Scale Ambiguity for Monocular Visual Odometry**, in Proceedings of International Conference on Ubiquitous Robot and Ambient Intelligence (URAI), 2013 [DOI](http://doi.org/10.1109/URAI.2013.6677403)
...
* Sunglok Choi, Jaehyun Park, Eulgyoon Lim, and Wonpil Yu, **Global Path Planning on Uneven Elevation Maps**, in Proceedings of International Conference on Ubiquitous Robot and Ambient Intelligence (URAI), 2012 [DOI](http://doi.org/10.1109/URAI.2012.6462928)
...
* Sunglok Choi, Ji Hoon Joung, Wonpil Yu, and Jae-Il Cho, **What Does Ground Tell Us? Monocular Visual Odometry under Planar Motion Constraint**, in Proceedings of International Conference on Control, Automation and Systems (ICCAS), 2011 [IEEExplore](http://ieeexplore.ieee.org/xpl/articleDetails.jsp?arnumber=6106228)
...
* Sunglok Choi, Taemin Kim, and Wonpil Yu, **Performance Evaluation of RANSAC Family**, in Proceedings of British Machine Vision Conference (BMVC), 2009 [PDF](https://www.bmva-archive.org.uk/bmvc/2009/Papers/Paper355/Paper355.pdf) [DOI](http://doi.org/10.5244/C.23.81) [Project Page](http://github.com/sunglok/rtl) <span style="color:red">"600+ Citations from Google Scholar"</span>
* Wonpil Yu et al., **Robot Navigation Service Platform in Large-Scale Artificial Environment: Tomorrow City Project in Korea**, in Proceedings of IARP Workshop on Service Robotics and Nanorobotics, 2009
* Sunglok Choi and Jong-Hwan Kim, **Robust Regression to Varying Data Distribution and Its Application to Landmark-based Localization**, in Proceedings of IEEE International Conference on Systems, Man and Cybernetics (SMC), 2008 [DOI](http://doi.org/10.1109/ICSMC.2008.4811834)
* Sunglok Choi and Jong-Hwan Kim, **Reducing Effect of Outliers in Landmark-based Spatial Localization using MLESAC**, in Proceedings of IFAC World Congress, 2008 [DOI](http://doi.org/10.3182/20080706-5-KR-1001.00393)
* Daniel Stonier, Se-Hyoung Cho, Sunglok Choi, Naveen S. Kuppuswamy and Jong-Hwan Kim, **Nonlinear Slip Dynamics for an Omniwheel Mobile Robot Platform**, in Proceedings of IEEE International Conference on Robotics and Automation (ICRA), 2007 [DOI](http://doi.org/10.1109/ROBOT.2007.363673)
...
* Sunglok Choi and Wonpil Yu, **Milk: Monocular Visual Odometry with Motion Constraints**, in Proceedings of International Conference on Ubiquitous Robot and Ambient Intelligence (URAI), 2012 [DOI](http://doi.org/10.1109/URAI.2012.6462972) (Video Paper)
* Sunglok Choi and Wonpil Yu, **Theta\* Path Planning with Averaged Cost on Non-uniform Cost Maps**, in Proceedings of International Conference on Ubiquitous Robot and Ambient Intelligence (URAI), 2010
...
* Sunglok Choi, **Efficient 3D Visual Perception for Intelligent Surveillance and Autonomous Navigation**, PhD Dissertation, KAIST, 2019 [KAIST Library](http://library.kaist.ac.kr/thesis02/2019/2019D020145539_S1.pdf)
  * Open-source Software: Chapter 2 is shared with code examples in [my online tutorial on 3D vision](http://github.com/sunglok/3dv_tutorial).
...
* 이유철, 박승환, 최성록, 유원필, **3D-RGB 포인트 클라우드 데이터 구축 방법**, 대한전자공학회 하계종합학술대회 (IEIE-Summer), 2013년
* 유원필, 최성록, 채희성, 정영숙, **실내환경 서비스로봇의 주행성능평가척도 연구**, 대한전자공학회 하계종합학술대회 (IEIE-Summer), 2013년
* 최성록, 박재현, 유원필, **평면운동에서의 에피폴라 기하학과 응용**, 한국로봇종합학술대회 (KRoC), 2013년 <span style="color:red">"Best Paper Finalist"</span>
* 박재현, 최성록, 유원필, **실외 도심환경 인지를 위한 3D 에지 검출**, 한국로봇종합학술대회 (KRoC), 2013년
* 최성록, 유원필, 정영숙, 이경근, **사용자 중심의 서비스로봇의 주행 성능 평가 방법**, 제어로봇시스템학회 학술대회 (ICROS), 2013년
* 유원필, 최성록, 정영숙, 이경근, **로봇주행 성능평가 척도에 대한 연구**, 제어로봇시스템학회 학술대회 (ICROS), 2013년
* 최성록, 유원필, 계중읍, 조재일, 박종현, **1-point RANSAC의 에러함수에 대한 고찰**, 한국로봇종합학술대회 (KRoC), 2012년 <span style="color:red">"Best Paper Finalist"</span>
* 이유철, 최성록, 유원필, 김성훈, **스캔 매칭 참조 데이터 선정 방법**, 한국로봇종합학술대회 (KRoC), 2012년
* 최성록, 정지훈, 유원필, 조재일, **정규화 1-point 알고리즘을 이용한 영상기반 오도메트리**, 한국로봇종합학술대회 (KRoC), 2011년 <span style="color:red">"Best Paper Award"</span>
...
* 최성록, 유원필, 조재일, 손주찬, **순환이 있는 경로의 추종을 위한 참조점 선택법**, 한국로봇종합학술대회 (KRoC), 2010년
...
* 최성록, **동적인 데이터 분포에 강인한 파라미터 추정기와 표식점 기반 위치 추정에의 응용**, 한국과학기술원(KAIST) 로봇공학학제전공 석사학위논문, 2008년 [KAIST Library](http://library.kaist.ac.kr/thesis02/2008/2008M020063575_S1Ver2.pdf)
  * Open-source Software: [RANSAC Template Library](http://github.com/sunglok/rtl) and [Triangulation Toolbox](https://github.com/mint-lab/TriangulationToolbox)
* 최성록, **x86과 리눅스 기반 이동 로봇의 Embedded System 설계 및 제작**, 서울대학교 전기공학부 학사학위논문, 2006년 [SNU Library](https://snu-primo.hosted.exlibrisgroup.com/permalink/f/1fgjt92/82SNU_INST21484589280002591)
* 최성록, **임베디드 시스템에서의 비전 기반 마우스 구현을 위한 세 가지 새로운 알고리즘**, 서울대학교 기계항공공학부 학사학위논문, 2004년 <span style="color:red">"Best Presentation Award"</span>
